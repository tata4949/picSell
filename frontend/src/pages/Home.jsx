...
export default function App() {
  ...
  return (
    <div style={s.root}>
      ...
      <div style={s.content}>
        {tab === "home"     && <HomeScreen     key="home"     navigate={navigate} />}
        {tab === "history"  && <HistoryScreen  key="history"  navigate={navigate} />}
        {tab === "stats"    && <StatsScreen    key="stats"    />}
        {tab === "settings" && <SettingsScreen key="settings" navigate={navigate} />}
      </div>
      ...
      <div style={s.heroCard}>
        ...
        <button
          style={{
            ...
            boxShadow: pressingCamera
              ? "0 2px 8px rgba(42,122,80,0.18)"
              : "0 4px 16px rgba(42,122,80,0.28)",
